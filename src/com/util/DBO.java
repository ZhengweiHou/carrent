	...
	*/
	public void open() 
	{
		try 
		{
			...
			//conn = DriverManager.getConnection("jdbc:microsoft:sqlserver://localhost:1433;databasename=zdh","sa","123");
			...
			conn=DriverManager.getConnection("jdbc:mysql://localhost/carrent","root","123456");
