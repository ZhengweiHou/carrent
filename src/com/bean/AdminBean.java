...
public class AdminBean {
	...
	//add manager
	public int addManager(String username,String password,String type,String isuse,String sf){
		String sql = "insert into admin(username,password,creattime,flag,isuse,logintimes,quanxian) values('"+username+"','"+password+"','"+date+"','"+type+"','"+isuse+"','0','"+sf+"')";
